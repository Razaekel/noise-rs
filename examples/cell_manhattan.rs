...
fn main() {
    debug::render_png("cell2_manhattan.png",
                      &PermutationTable::new(0),
                      1024,
                      1024,
                      scaled_cell2_manhattan);
    debug::render_png("cell3_manhattan.png",
                      &PermutationTable::new(0),
                      1024,
                      1024,
                      scaled_cell3_manhattan);
    debug::render_png("cell4_manhattan.png",
                      &PermutationTable::new(0),
                      1024,
                      1024,
                      scaled_cell4_manhattan);
}
