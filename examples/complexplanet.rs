...
fn main() {
    ...
    // 3: [River-valley module]: This ridged-multifractal-noise module
    ...
    // of the valleys. Note that this noise module generates ridged-multifractal
    ...
    // multifractal-noise modules contribute to the output value of this
    // subgroup.
    ...
    // the output values from the two ridged-multifractal-noise modules. This
    ...
    // this noise module selects the output value from the added-high-
    ...
    // appear in between the valleys. Note that this noise module generates
    ...
    // random values that will be used by subsequent noise modules to randomly
    ...
    // subsequent noise modules will later add oceanic trenches to the bottom of
    // the ocean.
    ...
    // This noise module also reduces the depth of the trenches so that their
    ...
    // output value is used by a subsequent noise module to add additional
    ...
    // transition between these two noise modules so that the badlands can blend
