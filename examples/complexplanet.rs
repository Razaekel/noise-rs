...
fn main() {
    ...
    // high zoom levels.
    let baseContinentDef_fb0: Fbm<Perlin>= Fbm::new(CURRENT_SEED)
    ...
    let baseContinentDef_fb1: Fbm<Perlin> = Fbm::new(CURRENT_SEED + 1)
    ...
    let mountainBaseDef_rm0: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 30)
    ...
    // next step.
    let mountainBaseDef_rm1: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 31)
        .set_frequency(367.0)
        .set_lacunarity(MOUNTAIN_LACUNARITY)
        .set_octaves(1);
    ...
    // mountains.
    let mountainousHigh_rm0: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 40)
    ...
    // mountains.
    let mountainousHigh_rm1: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 41)
    ...
    // terrain.
    let mountainousLow_rm0: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 50)
    ...
    // terrain.
    let mountainousLow_rm1: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 51)
    ...
    let hillyTerrain_bi: Billow<Perlin> = Billow::new(CURRENT_SEED + 60)
    ...
    let hillyTerrain_rm: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 61)
        .set_frequency(367.5)
        .set_lacunarity(HILLS_LACUNARITY)
        .set_octaves(1);
    ...
    let plainsTerrain_bi0: Billow<Perlin> = Billow::new(CURRENT_SEED + 70)
    ...
    let plainsTerrain_bi1: Billow<Perlin> = Billow::new(CURRENT_SEED + 71)
        .set_frequency(1097.5)
        .set_persistence(0.5)
        .set_lacunarity(PLAINS_LACUNARITY)
        .set_octaves(8);
    ...
    let badlandsSand_rm: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 80)
    ...
    let badlandsCliffs_fb: Fbm<Perlin> = Fbm::new(CURRENT_SEED + 90)
    ...
    let riverPositions_rm0: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 100)
        .set_frequency(18.75)
        .set_lacunarity(CONTINENT_LACUNARITY)
        .set_octaves(1);
    ...
    let riverPositions_rm1: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 101)
        .set_frequency(43.25)
        .set_lacunarity(CONTINENT_LACUNARITY)
        .set_octaves(1);
    ...
    let scaledMountainousTerrain_fb: Fbm<Perlin> = Fbm::new(CURRENT_SEED + 110)
        .set_frequency(14.5)
        .set_persistence(0.5)
        .set_lacunarity(MOUNTAIN_LACUNARITY)
        .set_octaves(6);
    ...
    let scaledHillyTerrain_fb: Fbm<Perlin> = Fbm::new(CURRENT_SEED + 120)
        .set_frequency(13.5)
        .set_persistence(0.5)
        .set_lacunarity(HILLS_LACUNARITY)
        .set_octaves(6);
    ...
    let continentalShelf_rm: RidgedMulti<Perlin> = RidgedMulti::new(CURRENT_SEED + 130)
    ...
    let continentsWithBadlands_bm: Fbm<Perlin> = Fbm::new(CURRENT_SEED + 140)
        .set_frequency(16.5)
        .set_persistence(0.5)
        .set_lacunarity(CONTINENT_LACUNARITY)
        .set_octaves(2);
