...
where
    SourceModule: NoiseFn<f32, 3>,
{
    angle_bounds: (f32, f32),
    ...
    SourceModule: NoiseFn<f32, 3>,
{
    ...
    pub fn set_angle_bounds(self, lower_bound: f32, upper_bound: f32) -> Self {
    ...
    pub fn set_height_bounds(self, lower_bound: f32, upper_bound: f32) -> Self {
    ...
    SourceModule: NoiseFn<f32, 3>,
{
    ...
    fn build(&self) -> NoiseMap {
        ...
        let x_step = angle_extent / width as f32;
        let y_step = height_extent / height as f32;

        for y in 0..height {
            let current_height = self.height_bounds.0 + y_step * y as f32;

            for x in 0..width {
                let current_angle = self.angle_bounds.0 + x_step * x as f32;
    ...
    SourceModule: NoiseFn<f32, 3>,
{
    ...
    pub fn set_x_bounds(self, lower_x_bound: f32, upper_x_bound: f32) -> Self {
        PlaneMapBuilder {
    ...
    pub fn set_y_bounds(self, lower_y_bound: f32, upper_y_bound: f32) -> Self {
        PlaneMapBuilder {
    ...
    SourceModule: NoiseFn<f32, 3>,
{
    ...
    fn build(&self) -> NoiseMap {
        ...
        let x_step = x_extent / width as f32;
        let y_step = y_extent / height as f32;

        for y in 0..height {
            let current_y = self.y_bounds.0 + y_step * y as f32;

            for x in 0..width {
                let current_x = self.x_bounds.0 + x_step * x as f32;
    ...
    SourceModule: NoiseFn<f32, 3>,
{
    ...
    pub fn set_latitude_bounds(self, min_lat_bound: f32, max_lat_bound: f32) -> Self {
        SphereMapBuilder {
    ...
    pub fn set_longitude_bounds(self, min_lon_bound: f32, max_lon_bound: f32) -> Self {
        SphereMapBuilder {
    ...
    pub fn latitude_bounds(&self) -> (f32, f32) {
        self.latitude_bounds
    }

    pub fn longitude_bounds(&self) -> (f32, f32) {
    ...
    SourceModule: NoiseFn<f32, 3>,
{
    ...
    fn build(&self) -> NoiseMap {
        ...
        let x_step = lon_extent / width as f32;
        let y_step = lat_extent / height as f32;

        for y in 0..height {
            let current_lat = self.latitude_bounds.0 + y_step * y as f32;

            for x in 0..width {
                let current_lon = self.longitude_bounds.0 + x_step * x as f32;
...
fn lat_lon_to_xyz(lat: f32, lon: f32) -> [f32; 3] {
