...
/// functions.
pub struct Max<F, Source1, Source2, const DIM: usize>
where
...
impl<F, Source1, Source2, const DIM: usize> Max<F, Source1, Source2, DIM>
where
    Source1: NoiseFn<F, DIM>,
    Source2: NoiseFn<F, DIM>,
{
...
impl<F, Source1, Source2, const DIM: usize> NoiseFn<F, DIM> for Max<F, Source1, Source2, DIM>
where
    F: Float,
    Source1: NoiseFn<F, DIM>,
    Source2: NoiseFn<F, DIM>,
