...
/// functions.
pub struct Min<F, Source1, Source2, const DIM: usize>
where
...
impl<F, Source1, Source2, const DIM: usize> Min<F, Source1, Source2, DIM>
where
    Source1: NoiseFn<F, DIM>,
    Source2: NoiseFn<F, DIM>,
{
...
impl<F, Source1, Source2, const DIM: usize> NoiseFn<F, DIM> for Min<F, Source1, Source2, DIM>
where
    F: Float,
    Source1: NoiseFn<F, DIM>,
    Source2: NoiseFn<F, DIM>,
