...
macro_rules! impl_hybridmulti {
    ($f:ty) => {
        impl HybridMulti<$f> {
            ...
            pub const DEFAULT_PERSISTENCE: $f = 0.25;
        ...
        impl Default for HybridMulti<$f> {
            fn default() -> Self {
                Self::new(Self::DEFAULT_SEED)
            }
        }

        impl MultiFractal for HybridMulti<$f> {
            type F = $f;
...
impl_hybridmulti!(f32);
impl_hybridmulti!(f64);

impl<F> Seedable for HybridMulti<F> {
...
macro_rules! hybridmulti {
    ($dim:expr, $vec:ident, $f:ty) => {
        impl NoiseFn<$f, $dim> for HybridMulti<$f> {
...
hybridmulti!(2, Vector2, f32);
hybridmulti!(3, Vector3, f32);
hybridmulti!(4, Vector4, f32);
hybridmulti!(2, Vector2, f64);
hybridmulti!(3, Vector3, f64);
hybridmulti!(4, Vector4, f64);
