...
pub struct Turbulence<Source, T> {
    ...
    seed: u32,
    x_distort_function: Fbm<T>,
    y_distort_function: Fbm<T>,
    z_distort_function: Fbm<T>,
    u_distort_function: Fbm<T>,
}
...
impl<Source, T> NoiseFn<Point2<T>, T> for Turbulence<Source, T>
where
...
impl<Source, T> NoiseFn<Point3<T>, T> for Turbulence<Source, T>
where
...
impl<Source, T> NoiseFn<Point4<T>, T> for Turbulence<Source, T>
where
