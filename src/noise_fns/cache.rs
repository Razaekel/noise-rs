...
impl<Source, T> NoiseFn<Point2<T>, T> for Cache<Source, T>
where
...
impl<Source, T> NoiseFn<Point3<T>, T> for Cache<Source, T>
where
...
impl<Source, T> NoiseFn<Point4<T>, T> for Cache<Source, T>
where
